...
1
2.
Trong đó, sinh viên được học các môn học thuộc danh mục 6.4.2.5 để
...
tối thiểu là 10
. Sinh viên có thể chọn các môn học chuyên đề tốt nghiệp được Khoa quy định từ danh sách 6.4.2. Hoặc, sinh viên tự chọn các môn học trong bảng sau:
