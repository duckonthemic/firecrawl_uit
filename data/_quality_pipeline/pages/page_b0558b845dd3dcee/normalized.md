...
[Hiện A. GIỚI THIỆU CHUNG](https://daa.uit.edu.vn/content/cu-nhan-khoa-hoc-nganh-khoa-hoc-du-lieu-ap-dung-tu-khoa-15-2020?page=2#)
...
[Hiện B. CHƯƠNG TRÌNH ĐÀO TẠO](https://daa.uit.edu.vn/content/cu-nhan-khoa-hoc-nganh-khoa-hoc-du-lieu-ap-dung-tu-khoa-15-2020?page=2#)
...
| Giáo dục đại cương | Lý luận chính trị | 11 | 37.19 | 45 TC |
| Toán – Tin học – Khoa học tự nhiên | 18 |
| Ngoại ngữ | 12 |
| Khác | 4 |
| Giáo dục chuyên nghiệp | Cơ sở nhóm ngành | 23 | 19.01 | 64 TC |
| Cơ sở ngành | 17 | 14.05 |
| Chuyên ngành (\*) | 24 | 19.83 |
| Tốt nghiệp<br><br>(\*\*) | Đồ án, hoặc môn thay thế | 2 | 9.92 | 12 TC |
| Khóa luận tốt nghiệp, hoặc các môn chuyên đề thay thế. | 10 |
| Tổng số tín chỉ học toàn khóa | | 121 | 100 | |
Lưu ý:

\- (\*) Sinh viên chọn học các môn học theo hướng dẫn tại mục 1.3.2.1.

\- (\*\*) Sinh viên hoàn thành khối kiến thức tốt nghiệp theo hướng dẫn tại mục 1.4.

\- Các khối kiến thức không tình bày Giáo dục thể chất và Giáo dục quốc phòng.

1.2 Khối kiến thức giáo dục đại cương
-------------------------------------------

Tổng cộng: **45 tín chỉ** (Đã tính số tín chỉ Anh văn và không tính các học phần Giáo dục quốc phòng và Giáo dục thể chất vào điểm trung bình chung tích lũy).
...
| 7. | DS005 | Giới thiệu ngành Khoa học dữ liệu | 1 | 1 | 0 |
| **Tổng số tín chỉ** | | | **23** | | |
...
#### 1.3.2.1. Hướng dẫn sinh viên chọn học các môn chuyên ngành

Sinh viên phải học các môn chuyên ngành tự chọn (trong danh mục **1.3.2.2**) tích luỹ số tín chỉ là X. Sinh viên có thể chọn học các môn tự chọn (trong danh mục **1.3.2.3**) tích luỹ số tín chỉ là Y. Hai giá trị X và Y thoả công thức sau:

![](https://daa.uit.edu.vn/sites/daa/files/uploads/img-khdl.png) (1)

#### 1.3.2.2. Nhóm các môn học tự chọn

| | | | | | |
| --- | --- | --- | --- | --- | --- |
| **STT** | **Mã môn** | **Tên môn** | **TC** | **LT** | **TH** |
| | DS200 | Phân tích dữ liệu lớn | 4 | 3 | 1 |
| | DS201 | Deep Learning trong khoa học dữ liệu | 4 | 3 | 1 |
| | DS204 | Đồ án khoa học dữ liệu và ứng dụng | 2 | 2 | 0 |
| | DS104 | Tính toán song song & phân tán | 4 | 3 | 1 |
| | DS106 | Tối ứu hoá và ứng dụng | 3 | 2 | 1 |
| | DS300 | Hệ khuyến nghị | 4 | 3 | 1 |
| | DS302 | Phân tích thống kê đa biến | 3 | 2 | 1 |
| | DS303 | Thống kê Bayes | 3 | 2 | 1 |
| | DS304 | Thiết kế và phân tích thực nghiệm | 3 | 3 | 0 |
| | IS353 | Mạng xã hội | 3 | 3 | 0 |
| | DS310 | Xử lý ngôn ngữ tự nhiên cho Khoa học Dữ liệu | 4 | 3 | 1 |
| | NT532 | Công nghệ Internet of things hiện đại | 3 | 2 | 1 |
| | DS301 | Các giải thuật khai phá dữ liệu lớn | 4 | 3 | 1 |
| | DS306 | Phân tích dữ liệu lớn trong tài chính | 3 | 3 | 0 |
| | DS307 | Phân tích dữ liệu truyền thông xã hội | 3 | 3 | 0 |
| | DS305 | Phân tích dữ liệu chuỗi thời gian và ứng dụng | 3 | 2 | 1 |
| | DS308 | Mô hình đồ thị xác suất | 4 | 3 | 1 |
| | IS217 | Kho dữ liệu và OLAP | 3 | 3 | 0 |
| | SE104 | Nhập môn Công nghệ phần mềm | 4 | 3 | 1 |
| | CS221 | Xử lý ngôn ngữ tự nhiên | 4 | 3 | 1 |
| Và các môn khác theo đề nghị của Khoa/Bộ môn | | | | | |
#### 1.3.2.3. Nhóm các môn học tự chọn tự do
...
Quy định đối với sinh viên khóa 2018, 2019
------------------------------------------

Sinh viên khóa 2018, 2019 chọn môn học đã cập nhật mới theo bảng quy đổi tương đương sau:

| | | | | |
| --- | --- | --- | --- | --- |
| **STT** | **Môn học trong** **CTĐT cũ** | | **Môn học tương đương mới** | |
| **Mã môn** | **Tên môn** | **Mã môn** | **Tên môn** |
| 1. | IT009 | Giới thiệu ngành | DS005 | Giới thiệu ngành Khoa học dữ liệu |
Ngoài danh sách môn học tự chọn thuộc CTĐT cũ. Sinh viên có thể chọn thêm các môn học tự chọn trong CTĐT này, tại mục 1.3.3.
...
| | **Các môn** **chuyên ngành** **tự chọn** (\*\*) | ≥ 4 | | |
| **Tổng số tín chỉ** | | ≥ 8 | | |
...
\- Tổng số tín chỉ toàn khoá là **1****21** (bao gồm 12 tín chỉ Anh văn).

\- (\*): Tuỳ thuộc vào trình độ Anh văn của mỗi sinh viên, kế hoạch học ngoại ngữ có thể khác nhau giữa các sinh viên.

\- (\*\*): Sinh viên chọn học các môn chuyên ngành theo hướng dẫn tại mục 1.3.2.1.

\- (\*\*\*): Tuỳ thuộc vào hình thức sinh viên chọn làm khoá luận tốt nghiệp hoặc học các môn chuyên đề thay thế, sinh viên tham khảo hướng dẫn tại mục 1.4
...
− Tích lũy tối thiểu **12****1 tín chỉ** (đã bao gồm 12 tín chỉ Anh văn) và hoàn thành các môn học bắt buộc của chương trình đào tạo.
