...
Sinh viên có thể tích luỹ nhiều hơn 138 tín chỉ
...
Ghi chú: (*) sinh viên chọn học một trong hai môn
PH002
,
PH003
...
Các môn học thuộc nhóm các môn học cơ sở nhóm ngành là bắt buộc đối với tất cả sinh viên. Tổng cộng
25
tín chỉ, gồm các môn học sau:
...
a) Nhóm các môn học chuyên ngành
gồm
2
loại:
...
-
Nhóm các môn học chuyên ngành tự chọn:
các môn học được trình bày chi tiết trong mục [5.3.3.2].
...
+
Bước 1:
Chọn 1 trong 4 hướng tự chọn được trình bày tại mục [1.3.3.1.1], [1.3.3.1.2], [1.3.3.1.3], [1.3.3.1.4], học 4 môn thuộc hướng đã chọn, tích lũy A tín chỉ.

+
Bước 2:
Chọn môn học tự chọn tự do sao cho tích lũy tối thiểu B tín chỉ. Cách chọn: ngoài các môn thuộc hướng đã chọn, sinh viên có thể chọn các môn thuộc 3 hướng còn lại làm môn tự chọn tự do, hoặc chọn các môn học tự chọn tại mục [1.3.3.2].
...
Hướng ứng dụng CNTT phân tích định lượng doanh nghiệp
...
Hướng ứng dụng CNTT quản lý, giám sát hoạt động doanh nghiệp
...
- Sinh viên tự chọn các môn học trong bảng sau để tích lũy tối thiểu
10 TC.
...
ngôn ngữ lập trình
,
chương trình, trình dịch, chương trình thực thi, phần mềm máy tính
;
...
Tên tiếng Anh
: Bussiness Process Management Systems
...
2.31 Hệ quản trị cơ sở dữ liệu
Oracle
...
Tên tiếng Anh:
Three- Dimentinal Geographic Information System
...
Kỹ sư ngành An toàn Thông tin (Áp dụng từ khóa 9-2014)

(02-08-2016)

Kỹ sư ngành Truyền thông và Mạng máy tính (Áp dụng từ khóa 9-2014)
