...
[Hiện A. GIỚI THIỆU CHUNG](https://daa.uit.edu.vn/content/cu-nhan-nganh-he-thong-thong-tin-ap-dung-tu-khoa-15-2020?page=2#)
...
[Hiện B. CHƯƠNG TRÌNH ĐÀO TẠO](https://daa.uit.edu.vn/content/cu-nhan-nganh-he-thong-thong-tin-ap-dung-tu-khoa-15-2020?page=2#)
...
| Khối kiến thức giáo dục chuyên nghiệp | Cơ sở nhóm ngành | 23 | |
| Kiến thức ngành | 60 | |
...
| 22. | IT010 | Tổ chức và cấu trúc máy tính | 2 | 2 | 0 |
| 23. | IT007 | Hệ điều hành | 4 | 3 | 1 |
| 24. | IS005 | Giới thiệu ngành Hệ thống thông tin | 1 | 1 | 0 |
### Nhóm các môn học ngành Hệ thống thông tin
...
| --- | --- | --- | --- | --- | --- |
| **STT** | **Mã môn học** | **Tên môn học** | **TC** | **LT** | **TH** |
| 25. | IS220 | Xây dựng HTTT trên các framework | 4 | 3 | 1 |
| 26. | IS201 | Phân tích thiết kế hệ thống thông tin | 4 | 3 | 1 |
| 27. | IS210 | Hệ quản trị cơ sở dữ liệu | 4 | 3 | 1 |
| 28. | IS208 | Quản lý dự án công nghệ thông tin | 4 | 3 | 1 |
| 29. | IS216 | Lập trình Java | 4 | 3 | 1 |
| 30. | IS336 | Hoạch định nguồn lực doanh nghiệp | 4 | 3 | 1 |
| 31. | IS207 | Phát triển ứng dụng web | 4 | 3 | 1 |
| 32. | NT118 | Phát triển ứng dụng trên thiết bị di động | 3 | 2 | 1 |
| 33. | IS211 | Cơ sở dữ liệu phân tán | 4 | 3 | 1 |
| 34. | IS252 | Khai thác dữ liệu | 4 | 3 | 1 |
| 35. | IS217 | Kho dữ liệu và OLAP | 3 | 3 | 0 |
| 36. | IS403 | Phân tích dữ liệu kinh doanh | 3 | 3 | 0 |
...
| 3. | IS254 | Hệ hỗ trợ quyết định | 3 | 3 | 0 |
| 4. | IS334 | Thương mại điện tử | 3 | 3 | 0 |
| 5. | IS332 | Hệ thống thông tin quản lý | 3 | 3 | 0 |
| 6. | IS351 | Phân tích không gian | 4 | 3 | 1 |
| 7. | IS352 | Hệ cơ sở dữ liệu không gian | 4 | 3 | 1 |
| 8. | IS251 | Nhập môn Hệ thống thông tin địa lý | 4 | 3 | 1 |
| 9. | IS335 | An toàn và bảo mật Hệ thống thông tin | 3 | 3 | 0 |
| 10. | IS339 | Sinh tin học (Bioinformatics) | 3 | 3 | 0 |
| 11. | EC202 | Nhập môn quản trị chuỗi cung ứng | 4 | 3 | 1 |
| 12. | EC331 | Quản trị chiến lược kinh doanh điện tử | 3 | 3 | 0 |
...
1.5 Kế hoạch giảng dạy mẫu
--------------------------

_[Bảng lớn: 55 dòng, 0 cột - bỏ qua để tiết kiệm dung lượng]_

[Hiện C. CHẤT LƯỢNG CAO](https://daa.uit.edu.vn/content/cu-nhan-nganh-he-thong-thong-tin-ap-dung-tu-khoa-15-2020?page=2#)
...
| 6 | NT118 | Phát triển ứng dụng trên thiết bị di động | Mobile Application Development | 3 | Tiếng Anh | Lê Trung Quân | | Áo |
...
Kế hoạch giảng dạy mẫu giống chương trình chính quy đại trà nhưng có thêm 02 môn Anh Văn 4 và Anh Văn 5 được giảng dạy trong Học kỳ 4 và Học kỳ 5 (Tổng số tín chỉ tích lũy của CTĐT chất lượng cao là 148 tín chỉ do bổ sung 2 môn Anh văn 4,5) như sau:
