...
Các môn học chuyên ngành (tự chọn khác ngành <= 12TC)
...
Tự chọn: sinh viên tích lũy tối thiểu 14TC trong danh sách các học phần sau
...
- Sinh viên có thể tự chọn các môn trong danh sách bên dưới
hoặc
các môn học trong các CTĐT đại học và sau đại học khác của Trường ĐH CNTT hoặc của trường khác thuộc ĐHQG (được Trường ĐH CNTT công nhận)
hoặc
các môn học thuộc nhóm các môn học chuyên đề tốt nghiệp (nếu các môn học này chưa được tính trong phần kiến thức tốt nghiệp).

-
Lưu ý:
Tổng số tín chỉ tích lũy tự chọn từ các CTĐT đại học và sau đại học khác (không thuộc khoa quản lý và có mã bắt đầu khác
SE
) chỉ được <= 12 tín chỉ.
...
Nhập môn ẩn thông tin và ứng dụng (2)
...
Chuyên đề các quy trình phát triển phần mềm hiện đại (1)
...
Các học phần tự chọn cơ sở ngành (1)
...
Các học phần tự chọn cơ sở ngành (2)
...
Các học phần tự chọn chuyên ngành (1)
...
Các học phần tự chọn chuyên ngành (2)
...
Đại học chính quy ngành Kỹ thuật Phần mềm, chương trình chất lượng cao
...
Kỹ thuật phần mềm, hệ chính quy, chương trình chất lượng cao
...
Chuẩn đầu ra về ngoại ngữ của chương trình chất lượng cao cao hơn một bậc so với chương trình đại trà
(bậc 4/6 theo đúng quy định tại thông tư 23/TT-BGDĐT
), một số chuẩn đầu ra quan trọng về kỹ năng mềm và kỹ năng chuyên môn có trình độ năng lực phát triển cao hơn so với chương trình đại trà. Sự khác biệt này đạt được là nhờ những yếu tố chính yếu sau đây:
...
Điều 12, Mục 3a:
Sinh viên CTCLC không đủ điều kiện để tiếp tục học tập CTCLC theo quy định của cơ sở đào tạo thì phải chuyển sang học CTĐT đại trà hoặc thôi học theo quy định của cơ sở đào tạo.

Điều 12, Mục 3b:
Sinh viên đang học CTĐT đại trà nếu có nhu cầu và đủ điều kiện theo quy định của cơ sở đào tạo có thể được xem xét tiếp nhận vào học CTCLC.

Để tạo điều kiện cho Sinh viên trong CTĐT đại trà và CTCLC có thể thay đổi CTĐT trong quá trình học
(áp dụng Điều 12/Mục 3a/b)
, Bảng CĐR CTCLC cho ngành Kỹ thuật phần mềm được xây dựng như CTĐT chính quy ngành Kỹ thuật phần mềm. Tuy nhiên, trình độ năng lực của một số chuẩn đầu ra môn học trong CTCLC sẽ cao hơn so với CTĐT chính quy (áp dụng Điều 5/Mục 2), nhấn mạnh đến yếu tố đạt được mục tiêu về CĐR về ngoại ngữ và thực hành, đặc biệt là các môn học cơ sở ngành, chuyên ngành được giảng dạy bằng tiếng Anh. Những môn học có sự khác biệt với chương trình đại trà được gọi chung là môn học chất lượng cao và được trình bày sau.
...
Kiến thức về phương pháp lập trình
...
Phát triển ứng dụng trên Windows, Web
...
Sinh viên được bổ sung các bài tập, thực hành nâng cao
...
9.1.1. Giao tiếp bằng ngôn ngữ tiếng Anh chuyên ngành
...
2.7.2 Phát triển ứng dụng trên Windows

3

4

Sinh viên được bổ sung các bài tập thực hành

10.2.2. Kỹ năng thiết kế, xây dựng và triển khai ứng dụng

2

3

Số lượng sinh viên ít nên tổ chức các nhóm nhỏ, hướng dẫn sinh viên thực hiện đồ án chi tiết hơn.
...
7.2,1. Điều hành hoạt động nhóm
...
Tốt nghiệp nước ngoài có luận văn viết bằng Tiếng Anh
