...
Các môn học nhóm này là bắt buộc đối với sinh viên. Tổng cộng
25
...
Các môn học nhóm này là bắt buộc đối với sinh viên ngành Khoa học máy tính. Sinh viên tích lũy 5 môn học (gọi là N) tổng số là
20
tín chỉ.
...
- Tổng số tín chỉ cho các môn tự chọn tự do tối thiểu là
10
tín chỉ.
...
- Sinh viên tích lũy tối thiểu
10
tín chỉ cho khối kiến thức tốt nghiệp.
...
- Mã môn học của Khóa luận tốt nghiệp là
CS505
.

1.4.2 Nhóm các môn học chuyên đề tốt nghiệp

Học các môn học chuyên đề tốt nghiệp thay thế khóa luận tốt nghiệp trong danh sách sau để tích lũy tối thiểu
10
tín chỉ.
...
- Sinh viên xem Chương trình đào tạo đầy đủ tại
...
Chuẩn quá trình và chuẩn đầu ra ngoại ngữ:

Sinh viên xem tại link
...
Chương trình đào tạo chất lượng cao được xây dựng và phát triển trên nền của CTĐT đại trà
có thêm 02 môn Anh văn 04 trong HK4 và Anh văn 5 trong HK5
. Vì vậy, hai chương trình này có cấu trúc nội dung tương tự như nhau.
...
Sinh viên có thể vận dụng những đặc điểm của các câu lệnh để đưa ra giải pháp phù hợp với yêu cầu của bài toán.
...
Sinh viên hiểu được nội dung các thông báo (lỗi, cảnh báo...) khi lập trình và cách khắc phục dựa trên các công cụ tìm kiếm, diễn đàn …
...
Sinh viên biết được kiến trúc và các thành phần của máy tính, ngôn ngữ lập trình.
...
Có khả năng thiết kế cấu trúc dữ liệu và kỹ thuật nâng cao hiệu quả của giải thuật, phân tích các ưu điểm và hạn chế của giải thuật Tối ưu hóa giải thuật.
...
Có khả năng áp dụng cho một số ứng dụng có liên quan
...
Có khả năng đọc hiểu tài liệu tiếng Anh chuyên ngành của môn học.
...
Vận dụng phương pháp heuristic, biểu diễn tri thức để giải quyết một số bài toán trong thực tế.
...
Phát hiện các vấn đề chính yếu trong kiến thức để đưa ra các giải pháp phù hợp giải quyết vấn đề.
...
Có khả năng nghe và hiểu được các kiến thức bằng tiếng Anh
...
Phân loại được các chức năng và các thành phần của một hệ thống.
...
So sánh để cải thiện tốc độ thuật giải trong quá trình giải quyết vấn đề.
...
Áp dụng các kỹ năng điều hành nhóm để nhóm hoạt động hiệu quả.
...
Đọc tài liệu và trình bày các ví dụ minh họa bằng tiếng Anh.
...
Làm rõ được được các mục tiêu của hệ thống ứng dụng, đồng thời cũng giải thích được các thành phần và kiến trúc của hệ thống đó.
...
Học slides bài giảng tiếng Anh và có thể giao tiếp bằng tiếng Anh trong lớp.
...
Sử dụng tài liệu chuyên ngành bằng tiếng Anh.
...
Xác định được bài toán và đánh giá được thuật toán giải quyết bài toán ấy.

Xây dựng một thuật toán hiệu quả trên cơ sở kiến thức về thiết kế thuật toán.
...
Biết được các giao tiếp thông dụng trong trình bày vấn đề nghiên cứu, vấn đề khoa học.
...
Có khả năng vận dụng các kiến thức cơ bản về tính toán đa phương tiện vào thực tế.
...
Có khả năng xây dựng và phát triển nhóm
...
Hiểu và giải thích được các thuật ngữ tiếng Anh liên quan tới tính toán đa phương tiện.
...
Hiểu và giải thích được các khái niệm cơ bản, thuật ngữ liên quan tới dữ liệu, phương pháp xử lý, ứng dụng đa phương tiện.
...
Có khả năng phân tích được các chức năng và các thành phần của hệ CSTT
...
Vận dụng tiếng Anh trong việc trình bày và thảo luận về những vấn đề kỹ thuật và ứng dụng bằng tiếng Anh
...
Trình bày các mục tiêu của hệ thống để có thể xác định được các thành phần và các chức năng của hệ CSTT trong hệ thống.
...
Phân tích các tác nhân ảnh hưởng đến hiệu quả hệ thống để có thể tối ưu hệ CSTT giúp hệ thống có thể hoạt động tốt hơn trong quá trình vận hành trong thực tế.
...
Phân tích các ưu điểm trong các mô hình BDTT để từ đó so sánh và chọn lựa mô hình để vận dụng vào thiết kế ứng dụng thực tế.
...
Có khả năng thuyết trình cũng như biết đặt câu hỏi, lắng nghe phản biện bằng tiếng Anh.
...
Giải thích các mục tiêu của hệ thống BDTT và hiểu được sự tác động của việc xây dựng các hệ thống đối với xã hội.
...
Xác định được các thành phần tri thức khái niệm và quan hệ, sự kiện và luật trong hệ thống để có thể vận dụng kiến thức toán học trong việc biểu diễn các thành phần đó.
...
Có khả năng vận dụng các kiến thức, phương pháp cơ bản về rút trích và biểu diễn đặc trưng ảnh, so khớp, phân đoạn ảnh và theo vết.
...
Hiểu và giải thích được các thuật ngữ chuyên ngành , có thể giải thích bằng tiếng Anh.
...
Hiểu và giải thích được các bài toán, phương pháp xử lý, ứng dụng thị giác máy tính.
...
- Hiểu, có thể giải thích và minh họa các thao tác xử lý hình ảnh hiển thị trên máy tính.

- Có khả năng áp dụng các phương pháp mô hình hóa.

- Có khả năng phân tích, đánh giá và lựa chọn phương pháp phù hợp với yêu cầu.

- Có khả năng phân tích, đánh giá và lựa chọn thuật toán phù hợp với yêu cầu.
...
Có khả năng trình bày, giải thích các khái niệm chuyên ngành, các phương pháp, giải thuật cơ bản bằng tiếng Anh
...
Có khả năng phân tích, xác định thành phần và kiến trúc hệ thống và lựa chọn giải pháp tối ưu.
...
SV CLC học slides bài giảng tiếng Anh và có thể giao tiếp bằng tiếng Anh với GV.
...
Hầu hết tài liệu chuyên ngành bằng tiếng Anh được sử dụng trong hệ CLC đều là tiếng Anh.
...
Chương trình tiên tiến ngành Hệ thống Thông tin (Áp dụng từ khóa 12 - 2017)

(28-11-2017)

Kỹ sư ngành Hệ thống Thông tin (Áp dụng từ khóa 12 - 2017)

(28-11-2017)

Cử nhân ngành Công nghệ Thông tin (Áp dụng từ Khoá 12 - 2017)
