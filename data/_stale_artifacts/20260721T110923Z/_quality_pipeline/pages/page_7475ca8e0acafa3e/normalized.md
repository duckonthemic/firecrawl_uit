...
Kiến thức nền tảng và chuyên sâu ngành HTTT
...
Khảo sát tài liệu, lập luận, phân tích và đề xuất giải pháp
...
Thiết kế, hiện thực hóa, đánh giá hệ thống
...
Quản lý dự án công nghệ thông tin y tế
...
Quản lý chuỗi cung ứng dược và thiết bị y tế
...
,
ngoài những môn tự chọn gợi ý dưới đây, sinh viên có thể chọn môn chuyên đề tốt nghiệp để tích lũy tín chỉ tự chọn tự do
)
...
Mã tiêu chuẩn dùng chung trong y tế (Medical Coding)
...
Điện toán đám mây và xử lý dữ liệu lớn
...
- Điện toán đám mây và xử lý dữ liệu lớn (IS406)

- Công nghệ Block chain (IS355)

- Đồ án chuyên ngành HTTT y tế (IS359)
