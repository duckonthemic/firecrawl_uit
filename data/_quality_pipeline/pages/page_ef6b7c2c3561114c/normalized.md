Cử nhân Văn bằng Đại học thứ 2 - Hình thức đào tạo từ xa qua mạng (Áp dụng từ Khoá 18 - 2023)
=============================================================================================

[1\. GIỚI THIỆU CHUNG](https://daa.uit.edu.vn/content/cu-nhan-van-bang-dai-hoc-thu-2-hinh-thuc-dao-tao-tu-xa-qua-mang-ap-dung-tu-khoa-18-2023?page=1#)
...
![](https://daa.uit.edu.vn/sites/daa/files/uploads/image001_6.png)
...
[2\. CHUẨN ĐẦU RA](https://daa.uit.edu.vn/content/cu-nhan-van-bang-dai-hoc-thu-2-hinh-thuc-dao-tao-tu-xa-qua-mang-ap-dung-tu-khoa-18-2023?page=1#)
...
Sinh viên tốt nghiệp chương trình đào tạo Cử nhân từ xa Văn bằng Đại học thứ 2 ngành Công nghệ thông tin phải đáp ứng các yêu cầu về chuẩn đầu ra (CĐR) sau:
...
[3\. CHƯƠNG TRÌNH ĐÀO TẠO](https://daa.uit.edu.vn/content/cu-nhan-van-bang-dai-hoc-thu-2-hinh-thuc-dao-tao-tu-xa-qua-mang-ap-dung-tu-khoa-18-2023?page=1#)
...
![](https://daa.uit.edu.vn/sites/daa/files/uploads/image002_6.png)
...
| 1. | IT003 | Cấu trúc dữ liệu và giải thuật | 4 | 3 | 1 |
| 2. | IT004 | Cơ sở dữ liệu | 4 | 3 | 1 |
| 3. | IT005 | Nhập môn mạng máy tính | 4 | 3 | 1 |
| 4. | IT012 | Tổ chức và cấu trúc máy tính II | 4 | 3 | 1 |
| 5. | IE005 | Giới thiệu ngành Công nghệ Thông tin | 1 | 1 | 0 |
| 6. | IE101 | Cơ sở hạ tầng công nghệ thông tin | 3 | 2 | 1 |
| 7. | IE103 | Quản lý thông tin | 4 | 3 | 1 |
| 8. | IE104 | Internet và công nghệ Web | 4 | 3 | 1 |
| 9. | IE105 | Nhập môn bảo đảm và an ninh thông tin | 4 | 3 | 1 |
| 10. | IE106 | Thiết kế giao diện người dùng | 4 | 3 | 1 |
| **Tổng số tín chỉ** | | | **40** | | |
### 3.4.2. Nhóm các môn học chuyên ngành

**Bắt buộc** đối với sinh viên ngành Công nghệ thông tin (**Tối thiểu 16 tín chỉ**).

Sinh viên được chọn môn học chuyên ngành tự do sao cho **tổng số tín chỉ** **³****16.**Trong đó, sinh viên được học các môn học thuộc danh mục 6.4.2.5 để **tích lũy không quá****1****0****tín chỉ** **.**
...
Bắt buộc đối với sinh viên không đủ điều kiện làm Khóa luận tốt nghiệp, SV phải tích lũy **tối thiểu****10****tín chỉ****.**SV có thể chọn các môn học chuyên đề tốt nghiệp được Khoa quy định từ danh sách 6.4.2. Hoặc, sinh viên tự chọn các môn học trong bảng sau:
...
[4\. KẾ HOẠCH GIẢNG DẠY](https://daa.uit.edu.vn/content/cu-nhan-van-bang-dai-hoc-thu-2-hinh-thuc-dao-tao-tu-xa-qua-mang-ap-dung-tu-khoa-18-2023?page=1#)
...
![](https://daa.uit.edu.vn/sites/daa/files/uploads/image003_2.png)
...
**Lưu ý** **:** (**\***) **Các** **môn học chuyên ngành** được hướng dẫn tại mục**6****.****4** **.2.**

[5\. ĐIỀU KIỆN TỐT NGHIỆP](https://daa.uit.edu.vn/content/cu-nhan-van-bang-dai-hoc-thu-2-hinh-thuc-dao-tao-tu-xa-qua-mang-ap-dung-tu-khoa-18-2023?page=1#)
